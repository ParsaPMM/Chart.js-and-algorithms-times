...
function pushValueChart() {
    ...
    // binarySearch
    let x1 = timeBinarySearch(Number(pushValue.value)) * 15 ;
    myChart.data.datasets[0].data.push(x1);
    // mergSort
    let x2 = timeMergSort(Number(pushValue.value)) * 5 ;
    myChart.data.datasets[1].data.push(x2);
    // random
    let x3 = timeRandomList(Number(pushValue.value)) * 2;
    myChart.data.datasets[2].data.push(x3);
    // bubbleSort
    let x4 = timeBubbleSort(Number(pushValue.value)) ;
